...
int lexi_find_dialogue(){
            ...
            if(ImGui::Button("Find##button")){
                ...
                std::regex conword_crit(search_conword, !match_case?std::regex::icase : std::regex::collate);
                std::regex natword_crit(search_natword, !match_case?std::regex::icase : std::regex::collate);
                std::regex defword_crit(search_definition, !match_case?std::regex::icase : std::regex::collate);
                std::regex pronun_crit(search_pronun, !match_case?std::regex::icase : std::regex::collate);
